...
namespace web_project_BE.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public async Task<IActionResult> getAccountStatus(string fullname)
        {
            var account = _context.Accounts
                .Where(a => a.account_username.Equals(fullname))
                .Select(a => a.account_status)
                .FirstOrDefault();
