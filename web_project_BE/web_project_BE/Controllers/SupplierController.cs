...
namespace web_project_BE.Controllers
{
    ...
    public class SupplierController : ControllerBase
    {
        ...
        [HttpGet("number_suppliers")]
        public async Task<IActionResult> getNumberSupplier()
        {
            var numberOfSuppliers = _context.Suppliers.Where(s => s.supplier_status.Equals(supplier_status.Yes.ToString())).Count();

            return Ok(numberOfSuppliers);
        }
