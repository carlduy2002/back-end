...
namespace web_project_BE.Controllers
{
    ...
    public class CategoryController : ControllerBase
    {
        ...
        [HttpGet("number_categories")]
        public async Task<IActionResult> getNumberCategory()
        {
            var numberOfCategories = _context.Categories.Where(c => c.category_status.Equals(category_status.Yes.ToString())).Count();
